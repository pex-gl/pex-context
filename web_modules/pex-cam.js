import { b as create$1, l as lookAt, s as set$1, i as invert, d as frustum, p as perspective$1, o as ortho, e as distance$1 } from './_chunks/vec2-BGM80osN.js';
import { s as set, g as dot, a as sub, b as add, f as scale, d as create, n as normalize, m as multMat4, e as copy, h as distance, l as length } from './_chunks/vec3-CYW9rG16.js';
import { c as clamp, t as toDegrees, a as toRadians, l as lerp$2 } from './_chunks/utils-Bi3aYt1K.js';
import { g as getDefaultExportFromCjs } from './_chunks/polyfills-BH44C1O_.js';
 ...
 */ class Camera {
   ...
   */ set(opts) {
        ...
        if (opts.position || opts.target || opts.up) {
            ...
            set$1(this.invViewMatrix, this.viewMatrix);
   ...
   */ set(opts) {
    ...
    handlePanZoomStart(touch0, touch1) {
        ...
        if (this.pan && camera) {
            ...
            set(this.clickTarget, camera.target);
    ...
    handlePanZoomMove(touch0, touch1) {
        ...
        if (this.pan && camera && this.panPlane) {
            ...
            multMat4(set(this.clickPosWorld, this.clickPosPlane), camera.invViewMatrix);
            multMat4(set(this.dragPosWorld, this.dragPosPlane), camera.invViewMatrix);
