...
var FlatToonShadingFrag = fs.readFileSync(__dirname + '/../sg/shaders/FlatToonShading.frag', 'utf8');
var DepthGradientFrag = fs.readFileSync(__dirname + '/../sg/shaders/DepthGradient.frag', 'utf8');
