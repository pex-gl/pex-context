...
//var GLSLifyProgram    = require('./GLSLifyProgram');

//var file = path.join(__dirname, 'common/base.vert');
var vert = [
  '#pragma glslify: base = require('+__dirname+'/common/base.vert)',
  '#pragma glslify: start = require('+__dirname+'/common/start.vert)',
  '#pragma glslify: end = require('+__dirname+'/common/end.vert)'
].join('\n');

var frag = [
  '#pragma glslify: base = require('+__dirname+'/common/base.frag)',
  '#pragma glslify: start = require('+__dirname+'/common/start.frag)',
  '#pragma glslify: end = require('+__dirname+'/common/end.frag)'
].join('\n');

function UberMaterial(uniforms) {
  var program = new GLSLifyProgram(vert, frag, { inline: true })
  /*
  var defaults = {
