define(["pex/core/Vec2", "pex/core/Rect", "pex/core/Context", "pex/core/Program", "pex/core/Vbo"], function(Vec2, Rect, Context, Program, Vbo) {
  var vert = ""
  ...
  function View(screenWidth, screenHeight, x, y, w, h, tex, texCoordRect, blending) {
    ...
    this.texCoordRect = texCoordRect = texCoordRect || new Rect(0, 0, 1, 1);
    ...
    var texCoords = [
       texCoordRect.x, 1 - texCoordRect.y - texCoordRect.height,
       texCoordRect.x + texCoordRect.width,  1 - texCoordRect.y - texCoordRect.height,
       texCoordRect.x + texCoordRect.width,  1 - texCoordRect.y,
       texCoordRect.x, 1 - texCoordRect.y
    ];
  ...
  View.prototype.setTexture = function(texture) {
    this.tex = texture;
  }

  View.prototype.draw = function(program, dontBlend) {
    var gl = Context.currentContext.gl;
    if (this.blending) {
      gl.enable(gl.BLEND);
